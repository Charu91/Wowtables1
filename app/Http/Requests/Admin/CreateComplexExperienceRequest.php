...
class CreateComplexExperienceRequest extends Request {
    ...
    public function rules()
    {
        ...
        $rules['product_variation_map'] = 'array';

        if($this->has('product_variation_map') && is_array($this->get('product_variation_map'))){
            foreach($this->get('product_variation_map') as $key => $product_variation){
                $rules['product_variation_map'.$key.'variant_product_id'] = 'required_with:product_variation_map|exists:products,id,type,variant';
                $rules['product_variation_map'.$key.'variant_option_id'] = 'required_with:product_variation_map|exists:product_variant_options,id';
            }
        }
