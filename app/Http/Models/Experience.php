...
class Experience extends Product{
    ...
    protected function savePricing($productId, $pricing){
        $pricing_insert_data = [
            ...
            'tax' => isset($pricing['tax'])? $pricing['tax'] : 0,
            'post_tax_price' => isset($pricing['post_tax_price'])? $pricing['post_tax_price'] : 0,
            'commission' => isset($pricing['commission'])? $pricing['commission'] : 0,
