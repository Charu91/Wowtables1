...
class ChangeGiftCardByAdminTable extends Migration {
	...
	public function up()
	{
		Schema::create('gift_card_by_admin', function(Blueprint $table)
		{
			$table->increments('id');
			...
			$table->integer('number_of_giftee');
	...
	{
		Schema::drop('gift_card_by_admin');
	}
