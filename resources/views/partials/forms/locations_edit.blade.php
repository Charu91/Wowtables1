<div class="form-group">
    ...
    <div class="col-sm-6">
        {!! Form::textarea('address[address]',$restaurantLocationAddress->address,['rows'=>'3','class'=>'form-control populate','required'=>'']) !!}
    </div>
</div>
<div class="form-group">
    <label for="address[pin_code]" class="col-sm-3 control-label">Pin Code <span class="required">*</span></label>
    <div class="col-sm-6">
        {!! Form::text('address[pin_code]',$restaurantLocationAddress->pin_code,['class'=>'form-control']) !!}
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-sm-6">
        {!! Form::text('address[latitude]',$restaurantLocationAddress->latitude,['class'=>'form-control populate latLong','required'=>'']) !!}
    </div>
</div>
<div class="form-group">
    ...
    <span class="required">*</span>
    <div class="col-sm-6">
        {!! Form::text('address[longitude]',$restaurantLocationAddress->longitude,['class'=>'form-control populate latLong','required'=>'']) !!}
    </div>
</div>
<!--<div class="form-group">
