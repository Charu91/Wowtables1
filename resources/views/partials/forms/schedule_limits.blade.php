<div class="row">
    <div class="col-lg-6">
        <div class="panel">
            <div class="form-group">
                <label for="attributes[min_people_per_reservation]" class="col-sm-6 control-label">Minimum People / Reservation <span class="required">*</span></label>
                <div class="col-sm-6">
                    {!! Form::text('attributes[min_people_per_reservation]',null,['class'=>'form-control','required'=>'']) !!}
                </div>
            </div>
            <div class="form-group">
                <label for="attributes[max_people_per_reservation]" class="col-sm-6 control-label">Maximum People / Reservation <span class="required">*</span></label>
                <div class="col-sm-6">
                    {!! Form::text('attributes[max_people_per_reservation]',null,['class'=>'form-control','required'=>'']) !!}
                </div>
            </div>
            <div class="form-group">
                <label for="attributes[max_reservations_per_time_slot]" class="col-sm-6 control-label">Maximum Reservation / Time Slot <span class="required">*</span></label>
                <div class="col-sm-6">
    ...
    <div class="col-lg-6">
        <div class="panel">
            <div class="form-group">
                <label for="attributes[max_reservations_per_day]" class="col-sm-6 control-label">Maximum Reservation / Day <span class="required">*</span></label>
                <div class="col-sm-6">
