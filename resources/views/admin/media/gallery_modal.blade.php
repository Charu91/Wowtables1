                    ...
                    <div class="col-lg-2">
                        <section class="panel">
                            <div class="panel-body bg-primary">
                                ...
                                <div style="height: 500px;" class="media-dropzone dz-square dz-clickable" id="mediaDropZoneGallery"></div>
                            </div>
                        </section>
                    </div>
...
<script type="text/javascript">
    ...
    var mediaDropZoneGallery = new Dropzone("#mediaDropZoneGallery", {
        init: function () {
            this.on('success', function (file, response) {
                mediaDropZoneGallery.removeFile(file);
                $('#mediaModal').modal('hide');
                refreshMediaModal();
            });
