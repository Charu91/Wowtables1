                    ...
                    <div class="col-lg-2">
                        <section class="panel">
                            <div class="panel-body bg-primary">
                                ...
                                <div style="height: 500px;" class="media-dropzone dz-square dz-clickable" id="mediaDropZoneSidebar"></div>
                            </div>
                        </section>
                    </div>
...
<script type="text/javascript">
    ...
    var mediaDropZoneListing = new Dropzone("#mediaDropZoneSidebar", {
