...
<section class="panel col-lg-8 col-lg-offset-2">
    ...
    {!! Form::model($sidebars,['route'=>['admin.promotions.listpage_sidebar.update',$sidebars->id],'method'=>'PUT','novalidate'=>'novalidate']) !!}
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                {!! Form::select('location_id',$cities_list,$sidebars->city_id,['class'=>'form-control populate select-location','data-plugin-selectTwo'=>'','required'=>'']) !!}
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-4">
                <div class="checkbox-custom checkbox-primary">
                    <input type="checkbox" value="1" id="attributes[show_in_experience]" name="show_in_experience" @if($sidebars->show_in_experience == 1) checked="checked" @else @endif>
            ...
            <div class="col-sm-4">
                <div class="checkbox-custom checkbox-primary">
                    <input type="checkbox" value="1" id="attributes[show_in_alacarte]" name="show_in_alacarte" @if($sidebars->show_in_alacarte == 1) checked="checked" @else @endif>
