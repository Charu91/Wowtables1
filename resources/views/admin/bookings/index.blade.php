                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                            @foreach($un_booking->statusArr as $key=>$val)
                                                <li>
                                                    {!! link_to_route('ChangeStatus',$val,null,['class'=>'change-status','data-reserv-id'=>$un_booking->id,'data-reserv-status'=>$key]) !!}
                                                </li>
                                            @endforeach
                                        </ul>
                                    </div>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                            @foreach($booking->statusArr as $key=>$val)
                                                <li>
                                                    {!! link_to_route('ChangeStatus',$val,null,['class'=>'change-status','data-reserv-id'=>$booking->id,'data-reserv-status'=>$key]) !!}
                                                </li>
                                            @endforeach
                                        </ul>
                                    </div>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                            @foreach($todaysbooking->statusArr as $key=>$val)
                                                <li>
                                                    {!! link_to_route('ChangeStatus',$val,null,['class'=>'change-status','data-reserv-id'=>$todaysbooking->id,'data-reserv-status'=>$key]) !!}
                                                </li>
                                            @endforeach
                                        </ul>
                                    </div>
