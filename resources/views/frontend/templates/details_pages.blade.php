...
<link href="{{URL::to('/')}}/assets/css/bootstrap.min.css?ver=1.0.4" rel="stylesheet" media="screen">
  ...
  <link href="{{URL::to('/')}}/assets/css/app_filters.css?ver=1.0.5" rel="stylesheet" media="screen">
    <link href="{{URL::to('/')}}/assets/css/app2.css?ver=1.0.5" rel="stylesheet" media="screen"> 
  <link href="{{URL::to('/')}}/assets/css/app_20_11_2014.css?ver=1.0.4" rel="stylesheet" media="screen"> 
    <link href="{{URL::to('/')}}/assets/css/datepicker.css?ver=1.0.2" rel="stylesheet" media="screen">
    <link href="{{URL::to('/')}}/assets/css/select2.css?ver=1.0.2" rel="stylesheet" media="screen">
  ...
  <link href="{{URL::to('/')}}/assets/css/app_new6.css?ver=1.0.5" rel='stylesheet' type="text/css">
    ...
    <script src="{{URL::to('/')}}/assets/js/jquery.js?ver=1.0.1"></script> 
        ...
        <div class="container">
          <div class="row">                      
            ...
            <div class="col-md-8 col-sm-8">
              <p class="pull-right concierge-info">Login to make a reservation online or Call our Concierge for assistance at 09619551387</p> 
