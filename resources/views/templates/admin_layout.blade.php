        ...
        {!! Html::script( elixir("js/all.js") ) !!}
            <script type="text/javascript">
                    ...
                    $(document).ready(function(){ console.log("here!");
                        ...
                        $("body").delegate('#close_changes,#cancel','click',function() {
                        ...
                        $("body").delegate('#date_edit','click',function() {
                        ...
                        $("body").delegate('#time_edit','click',function() {
                            if ($("#collapseTwo").hasClass("in")) {
                                $("#date_edit").click()
                            } else if ($("#collapseFour").hasClass("in")) {
                                $("#meal_edit").click()
                        ...
                        $("body").delegate('#cancel_current','click',function(e) {
                        ...
                        $("body").delegate('#ac_change_reservation','click',function() {
                            $("#last_reserv_date").val();
                            $("#last_reserv_time").val();
                            $("#last_reserv_outlet").val();
                            $("#last_reserv_party_size").val();
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    ...
                                    $("body").delegate('#meal_edit','click',function() {
                                        $("#time_edit").removeClass("hidden");
                                        $("#date_edit").removeClass("hidden");
                                        $("#party_edit").removeClass("hidden");
                                        $("#location_edit").removeClass("hidden")
                        ...
                        hide = 0;
                        sizehide = 0;
                        $("body").delegate('#locations1','change',function(e) {
                        ...
                        $("body").delegate('#ac_locations1','change',function(e) {
                        ...
                        $("body").delegate('#location_edit','click',function(e) {
                        ...
                        $("body").delegate('#party_size1','change',function(e) {
                        ...
                        $("body").delegate('#ac_party_size1','change',function(e) {
                            size = $(this).val();
                        ...
                        $("body").delegate('#ac_party_size2','change',function(e) {
                            size = $(this).val();
                        ...
                        $("body").delegate('#party_edit1','click',function(e) {
                            $('#save_changes').show();
                            if ($("#collapseTwo").hasClass("in")) {
                                $("#date_edit1").click();
                                if ($("#date_edit1 span").text() != "") {
                        ...
                        $("body").delegate('#time_edit1','click',function(e) {
                            $("#cant_do_reserv1,#cant_do_reserv2,#brs_my_reserv").addClass("hidden");
                            $("#select_table_exp").removeClass("hidden");
                            $("#select_all_data").addClass("hidden");
                            $("#or_reservation").removeClass("hidden");
                        ...
                        $("body").delegate('#date_edit1','click',function(e) {
                            $("#cant_do_reserv1,#cant_do_reserv2,#brs_my_reserv").addClass("hidden");
                            $("#select_table_exp").removeClass("hidden");
                            $("#select_all_data").addClass("hidden");
                            $("#or_reservation").removeClass("hidden");
                        ...
                        $("body").delegate('#ac_date_edit1','click',function(e) {
                        ...
                        $("body").delegate(".actives label", "click", function() {
                        ...
                        $("body").delegate("#ac_select_table", "click", function() {
                            e.preventDefault();
                        ...
                        $("body").delegate("#ac_select_table2", "click", function() {
                            e.preventDefault();
                        ...
                        $("body").delegate("#info_edit1", "click", function() {
                        ...
                        $("body").delegate("#ac_info_edit1", "click", function() {
                            open_order_info = true;
                        ...
                        $("body").delegate("#ac_info_edit2", "click", function() {
                            open_order_info = true;
                        ...
                        $("body").delegate(".alacarte_time", "click", function() { //console.log("called");
                            $("#ac_time_edit2 span").text($(this).text());
                            $("#ac_time_edit2").removeClass("hidden");
                        ...
                        $("body").delegate("#a_la_carte", "click", function() {
                        ...
                        $("body").delegate("#show_more_reservations", "click", function() {
                            $(this).hide();
                            $("#load_layer").show();
                        ...
                        $("body").delegate(".forward_guests", "click", function() {
                        ...
                        $("body").delegate("#ac_party_edit1", "click", function() {
                        ...
                        $("body").delegate("#ac_party_edit2", "click", function() {
                            if ($("#ac_collapseTwo").hasClass("in")) {
                                $("#ac_date_edit2").click();
                                if ($("#ac_date_edit2 span").text() != "") {
                        ...
                        /*end alacarte page*/
                        //$("#ac_date_edit1").click(function() {
                        $("body").delegate("#ac_date_edit1", "click", function() {
                            if ($("#ac_collapseThree").hasClass("in")) {
                                $("#ac_time_edit1").click()
                            } else if ($("#ac_collapseFour").hasClass("in")) {
                                $("#ac_meal_edit1").click()
                        ...
                        $("body").delegate("#ac_time_edit1", "click", function() {
                            if ($("#ac_collapseTwo").hasClass("in")) {
                                $("#ac_date_edit1").click()
                            } else if ($("#ac_collapseFour").hasClass("in")) {
                                $("#ac_meal_edit1").click()
                        ...
                        /*end alacarte*/
                        $("body").delegate(".ac_actives label", "click", function() {
                            label_id = $(this).attr("id");
                        ...
                        $("body").delegate(".ac_time", "click", function() {
