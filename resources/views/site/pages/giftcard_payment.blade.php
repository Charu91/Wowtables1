...
//$url="http://wowtables.app/giftcard_payment/process_response";
$url="http://sit.wowtables.com/giftcard_payment/process_response";
//$url="http://wowtables.com/giftcard_payment/process_response";
...
<form  method="post" action="<?php echo $action_url;?>" name="frmTransaction" id="frmTransaction" onSubmit="return validate()">
    ...
    <input name="surl" type="hidden"  value="<?php echo $url;?>" />
    <input name="furl" type="text"  value="<?php echo $url;?>" />
