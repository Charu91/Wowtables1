...
">
    <tr>
        <td>
            <?php
            if($post_data['reservation_type']=='alacarte'){
            ...
            <table width="600" border="0">
                ...
                <tr >
                    <td class="top" style="height:66px; padding:0 30px 0 35px;">
                        <table width="535" border="0">
                            <tr>
                                ...
                                <td class="mid-top" style=" padding-top:44px; width:283px; height:22px; letter-spacing:2px; color:#eab703; font-size:12px; font-weight:bold; text-transform:uppercase;"><?php echo $your_booking_order;?></td>
                                <td class="right-top" style="width:15%;padding-top:20px; height:46px; letter-spacing:1px; color:#fff; font-size:7px; text-transform:uppercase; text-align:right;">
                                    follow&nbsp;us
                ...
                <tr>
                    <td class="content" style="padding:0 30px 0 35px;">
                        ...
                        <table width="535" border="0">
                            ...
                            <tr>
                                <td class="top-content" style="padding:11px 161px 9px 186px; height:33px; width:188px; color:#fff; font-size:14px; letter-spacing:2px; line-height:33px;">
                            ...
                            <tr style="width:535px; float:left;">
                                <td class="bottom-heading"  style="float:left; width:222px; height:17px; text-align:center; line-height:17px; text-transform:uppercase; background:#000; -moz-box-shadow: 0px 1px 1px #848182; -webkit-box-shadow: 0px 1px 1px #848182; box-shadow: 0px 1px 1px #848182; color:#fff; font-size:12px; position:relative; z-index:9;">A la carte Terms & Conditions</td>
                            </tr>
